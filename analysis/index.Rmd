...
+ (`flash`) precision matrix estimation: [flash_omega](flash_omega.html)
  ...
  + the value of each entry of the matrix corresponds to the strength of the pairwise position-position interaction
    + from the $Lq \times Lq$ precision matrix, each $q \times q$ submatrix corresponding to a position-position interaction is represented into a Frobeniues norm in the final $L\times L$ matrix
...
+ precision matrix estimation (`flash` and `flashier`): [pdz](pdz.html)
  ...
  + the low-rank structure seems looking into
