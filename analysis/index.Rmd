...
+ Ten More Toy Data: [toy10](toy10.html)
  + due to small sample size, the esitmate differs significantly by input data, which are drawn iid from the same data generating process.  
  + the weaker signal for the size-6 group, observed in the original toy data, may not be the estimation method's limitation; there's also a case where the size-6 group has the largest signal
